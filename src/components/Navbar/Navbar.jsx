...
const NavBar = () => {
  ...
  return (
    ...
    <span><a> <FaPhoneAlt size={20}/> 8618995465</a>
    &nbsp; &nbsp; &nbsp;&nbsp;
    <a><IoIosMail size={30} />info@stockzone.co.in </a></span>
            </div>
    <Navbar
      fixed="top"
      expand="md"
      ...
      <Container className="navbar-container">
        ...
        {/* className={isFixed ? "d-none" : "justify-content-end flex-grow-1 pe-3"} */}
          <Nav className="justify-content-end flex-grow-1 pe-3" >
            ...
            <Dropdown as={Nav.Item}        className={isFixed ? "d-none" : "navbar-link"}>
        <Dropdown.Toggle as={Link}  className={isFixed ? "d-none" : "navbar-link"}>
