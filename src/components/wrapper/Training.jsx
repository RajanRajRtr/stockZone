              ...
              <div class="Trainingbox">
                <div class="Trainingbox-top">
                  ...
                  <p class="Trainingdescription">
                    Duration : 05 Hours
                    <br />
                    Skill Layout : Beginner
                    <br />
                    Live Market Assistance : Yes
                    <br />
                    Mode : Offline / Online
                    <br />
                    24*7 Support : Yes
      ...
      >
        ...
        <Modal.Body style={{ textAlign: "center" }}>
          <div>
            <Row>
              <h3>
                4-6 Hours | Beginner Level | Live Market Assistance Overview
                Overview
              </h3>
              <Col md={6}>
                ...
                to meet the working capital requirements. And so, companies
                invite normal people like you and me to put some money in their
                company so that they can run the business efficiently and in
                return investors get a share of whatever profit they make.
              ...
              <Col md={12}>
                <h4>Course Format</h4>
                <p>
                  During this program, irrepective of whether you are a fresher,
                  experieced in stock market you shall learn basics of stock
                  market with a touch of IPO , how to select sectors for trading
                  or investments , balance sheet, profit and loss statements and
                  cash flow analysis, Financial ratios, Logic behind
                  derivatives, Intraday and delivery trading and risk involved
                  with it, How to use Demat account etc.
                </p>
              </Col>
            </Row>
            <hr />
            <Row style={{ textAlign: "center" }}>
              <Col md={12}>
                ...
                <p>
                  ...
                  24x7 Support: Yes
                  <br />
                  Mode: Online/Offline/Pre-Recorded
                  <br />
            ...
            <Row style={{ textAlign: "center" }}>
              <Col md={12}>
                ...
                <p>
                  {" "}
                  Introduction to Stock Market *IPO
                  <br />
                  *Investment & Trading
                  <br />
                  ...
                  *How to use Demat Account?
                  <br />
                  *How to choose a brokerage company
                  <br />
